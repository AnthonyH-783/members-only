...
import { registerValidation, verifyPasscode } from "../controllers/validators/index.validation.js";
...
formRouter.post("/join", verifyPasscode,  usersController.promoteToMember);
